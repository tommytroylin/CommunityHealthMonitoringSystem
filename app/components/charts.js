...
export class CHMSFoodWebChart extends React.Component {
  ...
  render() {
    const callback = () => {
      this.refs.chart.getWrappedInstance()
        .updateChart({ data: { choice: this.refs.state1.getSelectValue() } });
    };
    return (
      <div>
        <Row>
  ...
  render() {
    ...
    return (
      <div>
        ...
        <Row>
          <Col xs={12}>
            <CHMSHighchart ref="chart" uid={'stateExercise'}
                           apiAddress={ApiAddresses.stateExerciseChart}
  ...
  render() {
    ...
    return (
      <div>
        ...
        <Row>
          <Col xs={12}>
            <CHMSHighchart ref="chart" uid={'sportExercise'}
                           apiAddress={ApiAddresses.sportExerciseChart}
