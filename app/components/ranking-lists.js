...
// like this <CHMSRankingList uid={'profileSport'} apiAddress={ApiAddresses.sportRankList}
// {...this.props}/>

//To create a static list, assign property apiAddress to null and listData to the static list data
// like this <CHMSRankingList uid={'staticProfileSport'} apiAddress={null} listData={listConfig}
// {...this.props}/>